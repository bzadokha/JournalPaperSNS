...
def synConnectMap(netModel, nsiNeuron, numNeurons,
    ...
    for j in range(numNeurons):
        ...
        nsi1[k1, :] = ComboVec(theta2Bell=th1, theta3Bell=3, mag=mag, comboAct=nsi1, gMax=gI, delE=dEex)
        k1 += 1
    ...
    kSynX1 = sp.linalg.solve(nsi1, np.ones_like(deltaX))
    kSynY1 = sp.linalg.solve(nsi1, np.ones_like(deltaY))
